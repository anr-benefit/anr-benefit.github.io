...
## Control engineering and reduced-order modeling
...
`LightControl` is at attempt to emulate the MATLAB Control toolbox in Fortran. It provides high-level interfaces to numerous utilities provided by the FORTRAN77 [`SLICOT`](https://www.slicot.org/) toolbox. It is in its very early development stage but already provides high-levels interfaces for solving Lyapunov and Riccati equations, or computing controllability and observability gramians of an LTI system.
